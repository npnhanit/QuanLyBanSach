...
if (isset($_SESSION['user'])) {
    ...
    $querysodonhangchuaduyet = sodonhangchuaduyet();
?>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="row">
                    <div class="h1 col-sm-12 col-xs-12 text-center" style="color: rgb(24, 145, 145);"><strong>--Đơn hàng chưa duyệt--</strong></div>
                </div>
                ...
                <?php while ($sodonhang = mysqli_fetch_array($querysodonhangchuaduyet)) {
                ...
                ?>
                    <div class="row" style="border: 1px solid rgb(24, 145, 145);">
                        ...
                        <div class="row" style="margin-top:0px;">
                            ...
                            <div class="col-sm-6 col-xs-6">
                                ...
                                <div class="btn btn-warning" id="duyetdonhang<?php echo $sodonhang['SoDonDH']; ?>">Duyệt đơn</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <script>
                        $(document).ready(function(e) {
                            $('#duyetdonhang<?php echo $sodonhang['SoDonDH']; ?>').click(function(e) {
                                e.preventDefault();
                                $.ajax({
                                    url: './lib/duyetdh.php',
                                    type: 'POST',
